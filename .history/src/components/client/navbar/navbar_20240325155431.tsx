    ...
    return (
        ...
        >
            ...
            <div className="z-10 w-full flex items-center">
                ...
                >
                    <NavbarItem>
                        <Link className={`${pathname==="/" ? "text-danger-500" : "text-white"}`} href="/">
                            Tours
                        </Link>
                    </NavbarItem>
                    <NavbarItem isActive>
                        <Link href="/search-flight" aria-current="page" className={`${pathname==="/search-flights" ? "text-danger-500" : "text-white"}`}>
                            Flights
                        </Link>
                    </NavbarItem>
                    <NavbarItem>
                        <Link  href="/search-hotel" className={`${pathname==="/search-hotels" ? "text-danger-500" : "text-white"}`}>
                            Hotels
                        </Link>
                    </NavbarItem>
                </NavbarContent>
