                    ...
                    <ul className="text-white grid grid-cols-5 mt-5">
                        {
                            activities.map((activity) => (
                                <li className= "flex items-center justify-center gap-5 flex-col cursor-pointer" key={activity.name}>
                                    <div className="p-5 bg-white bg-opacity-20 rounded-full hover:bg-opacity-30 transition-all duration-300"></div>
                                </li>
                            ))
                        }
                    </ul>
