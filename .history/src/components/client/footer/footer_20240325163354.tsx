        ...
        >
            ...
            <div className="relative z-10 p-4 grid grid-cols-4 gap-20 text-white">
                ...
                <div className="flex flex-col gap-3 pt-10">
                    <h3 className="text-3xl font-medium to-danger-500">Destination</h3>
                ...
                <div className="flex flex-col gap-3 justify-between pt-10">
                    <h3 className="text-3xl font-medium to-danger-500">Adventures</h3>
                    <ul className="flex flex-col gap-1">
                        <li className="cursor-pointer">
                            Extreme
                        </li>
