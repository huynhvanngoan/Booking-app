            ...
            <div className="relative z-10 p-4 grid grid-cols-4 gap-20 text-white">
                ...
                <div className="flex flex-col gap-3 pt-10">
                    ...
                    <ul className="flex gap-5 mt-5">
                        <li className="bg-purple-500 bg-opacity-30 rounded-lg to-purple-500 text-2xl p-3 cursor-pointer">
                            <FaFacebookF />
                        </li><li className="bg-purple-500 bg-opacity-30 rounded-lg to-purple-500 text-2xl p-3 cursor-pointer">
                            <FaFacebookF />
                        </li><li className="bg-purple-500 bg-opacity-30 rounded-lg to-purple-500 text-2xl p-3 cursor-pointer">
                            <FaFacebookF />
                        </li>
