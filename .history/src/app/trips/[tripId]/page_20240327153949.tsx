...
import { FaCheck, FaFacebook, FaInstagram, FaTiktok, FaTwitter } from "react-icons/fa";
                                ...
                                <div className="p-10 bg-[#f5f5fe] rounded-lg border border-gray-200 gap-3 flex flex-col">
                                    ...
                                    <ul className="grid grid-cols-4 gap-5 mt-3">
                                        {tripData.themes.map((theme) => (
                                            <li key={theme}>
                                                <span className="text-sm text-blue-500 bg-blue-200 p-2 rounded-full"><FaCheck /></span>
                                                <span>{theme}</span>
                                            </li>
                                        ))}
                                    </ul>
