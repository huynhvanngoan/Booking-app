...
export default function App() {
    ...
    }, [bookings, hasSearchFilter, statusFilter, filterValue]);
    ...
    const renderCell = React.useCallback((Bookings: Bookings, columnKey: React.Key) => {
        const cellValue = Bookings[columnKey as keyof User];
